...
func TestArgumentType_IsValid(t *testing.T) {
	tests := []struct {
		...
		{"epic-search is valid", ArgumentTypeEpicSearch, true},
		{"epic-search string conversion is valid", ArgumentType("epic-search"), true},
		{"epic_search with underscore is invalid", ArgumentType("epic_search"), false},
